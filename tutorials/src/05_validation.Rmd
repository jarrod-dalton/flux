...
```{r plot-battery-hist, fig.width=6, fig.height=3}
...
```{r plot-event-risk, fig.width=6, fig.height=3.5}
...
```{r plot-risk-comparison, fig.width=6.5, fig.height=4}
...
```{r plot-calibration, fig.width=6, fig.height=4}
...
```{r plot-auc, fig.width=6, fig.height=3.5}
...
```{r plot-battery-comparison, fig.width=6.5, fig.height=4}
m <- vs$metrics
